                ...
                >
                    <div className="relative flex flex-col items-center">
                            ...
                            <div className="flex overflow-hidden">
                                {'MMH'.split('').map((letter, index) => (
                                    <motion.span
                                        ...
                                        className="inline-block text-4xl font-bold bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-clip-text text-transparent"
                                    >
                                        {letter}
                                    </motion.span>
                                ))}
                        ...
                        <motion.div
                            ...
                            className="mb-8 w-[480px] bg-black/50 rounded-lg p-4 font-mono text-sm backdrop-blur-sm border border-white/10"
                        >
